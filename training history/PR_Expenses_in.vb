...
Public Class PR_Expenses_in
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "training_history.PR_Expenses_in.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_trainingIn_id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPR_Expenses_in
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PR_Expenses_in = New PR_Expenses_in()
        rpt.Site = Me.Site
        Return rpt
    End Function
