...
Public Class RP_Employees
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "training_history.RP_Employees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRP_Employees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RP_Employees = New RP_Employees()
        rpt.Site = Me.Site
        Return rpt
    End Function
